...
Begin VB.Form frmColorz 
   ...
   Begin VB.PictureBox Picker1 
      ...
      Height          =   2850
      Left            =   120
      MouseIcon       =   "frmColorz.frx":114C
      Picture         =   "frmColorz.frx":1456
      ScaleHeight     =   2790
      ScaleWidth      =   2625
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   255
      Left            =   120
      MouseIcon       =   "frmColorz.frx":19438
      Picture         =   "frmColorz.frx":19742
      ScaleHeight     =   255
      ScaleWidth      =   3000
      TabIndex        =   0
      TabStop         =   0   'False
...
BTransfer = txtB.Text
'Set values
HTMLEditor.RichTextBox1.SelText = HexTransfer
Unload Me
End Sub
