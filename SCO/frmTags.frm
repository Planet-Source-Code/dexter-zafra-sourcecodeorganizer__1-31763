...
On Error Resume Next
  If TagList.SelectedItem.Text = "<a>" Then
   Unload Me
   TabNumber = 0
   frmTagEdit.Show 1, frmmain
   Exit Sub
  End If
 If TagList.SelectedItem.Text = "<br>" Then frmmain.rtbnet.SelText = "<br>"
 If TagList.SelectedItem.Text = "<blink>" Then frmmain.rtbnet.SelText = "<blink> </blink>"
 If TagList.SelectedItem.Text = "<center>" Then frmmain.rtbnet.SelText = "<center> </center>"
 If TagList.SelectedItem.Text = "<dir>" Then frmmain.rtbnet.SelText = "<dir> </dir>"
  If TagList.SelectedItem.Text = "<div>" Then
   ...
   Exit Sub
  End If
 If TagList.SelectedItem.Text = "<head>" Then frmmain.rtbnet.SelText = "<head> </head>"
 If TagList.SelectedItem.Text = "<html>" Then frmmain.rtbnet.SelText = "<html> </html>"
 If TagList.SelectedItem.Text = "<menu>" Then frmmain.rtbnet.SelText = "<menu> </menu>"
 If TagList.SelectedItem.Text = "<nobr>" Then frmmain.rtbnet.SelText = "<nobr> </nobr>"
 If TagList.SelectedItem.Text = "<noembad>" Then frmmain.rtbnet.SelText = "<noembad> </noembad>"
 If TagList.SelectedItem.Text = "<nolayer>" Then frmmain.rtbnet.SelText = "<nolayer> </nolayer>"
 If TagList.SelectedItem.Text = "<plain text>" Then frmmain.rtbnet.SelText = "<plain text> </plain text>"
 If TagList.SelectedItem.Text = "<strong>" Then frmmain.rtbnet.SelText = "<strong> </strong>"
 If TagList.SelectedItem.Text = "<strike>" Then frmmain.rtbnet.SelText = "<strike> </strike>"
 If TagList.SelectedItem.Text = "<title>" Then frmmain.rtbnet.SelText = "<title> </title>"
 If TagList.SelectedItem.Text = "<u>" Then frmmain.rtbnet.SelText = "<u> </u>"
 If TagList.SelectedItem.Text = "<ul>" Then frmmain.rtbnet.SelText = "<ul> </ul>"
  ...
  If TagList.SelectedItem.Text = "<img>" Then
   ...
   Exit Sub
  End If
 If TagList.SelectedItem.Text = "<frame>" Then frmmain.rtbnet.SelText = "<frame> </frame>"
 If TagList.SelectedItem.Text = "<H1>" Then frmmain.rtbnet.SelText = "<H1> </H1>"
 If TagList.SelectedItem.Text = "<H2>" Then frmmain.rtbnet.SelText = "<H2> </H2>"
 If TagList.SelectedItem.Text = "<H3>" Then frmmain.rtbnet.SelText = "<H3> </H3>"
 If TagList.SelectedItem.Text = "<H4>" Then frmmain.rtbnet.SelText = "<H4> </H4>"
 If TagList.SelectedItem.Text = "<H5>" Then frmmain.rtbnet.SelText = "<H5> </H5>"
 If TagList.SelectedItem.Text = "<H6>" Then frmmain.rtbnet.SelText = "<H6> </H6>"
 ...
 If TagList.SelectedItem.Text = "<th>" Then frmmain.rtbnet.SelText = "<th> </th>"
 If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "button" & Chr(34) & ">" Then frmmain.rtbnet.SelText = "<Input type=" & Chr(34) & "button" & Chr(34) & ">"
  If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "checkbox" & Chr(34) & ">" Then
   ...
   Exit Sub
  End If
 If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "File" & Chr(34) & ">" Then frmmain.rtbnet.SelText = "<Input type=" & Chr(34) & "File" & Chr(34) & ">"
  If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "hidden" & Chr(34) & ">" Then
   ...
   Exit Sub
  End If
 If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "image" & Chr(34) & ">" Then frmmain.rtbnet.SelText = "<Input type=" & Chr(34) & "image" & Chr(34) & ">"
 If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "password" & Chr(34) & ">" Then frmmain.rtbnet.SelText = "<Input type=" & Chr(34) & "password" & Chr(34) & ">"
  If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "radio" & Chr(34) & ">" Then
   ...
   Exit Sub
  End If
 If TagList.SelectedItem.Text = "<Input type=" & Chr(34) & "reset" & Chr(34) & ">" Then frmmain.rtbnet.SelText = "<Input type=" & Chr(34) & "reset" & Chr(34) & ">"
