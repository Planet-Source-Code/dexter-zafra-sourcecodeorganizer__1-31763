...
Begin VB.Form frmTagEdit 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(0)   =   "Anchor"
      TabPicture(0)   =   "frmTagEdit.frx":014A
      ...
      TabCaption(1)   =   "Body"
      TabPicture(1)   =   "frmTagEdit.frx":0166
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Command18(5)"
      Tab(1).Control(1)=   "Frame2"
      Tab(1).Control(2)=   "Command2"
      Tab(1).Control(3)=   "Picture2(0)"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "cdc1"
      Tab(1).ControlCount=   5
      TabCaption(2)   =   "CheckBox"
      TabPicture(2)   =   "frmTagEdit.frx":0182
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Picture1(12)"
      Tab(2).Control(1)=   "Command18(6)"
      Tab(2).Control(2)=   "Frame1(1)"
      Tab(2).Control(3)=   "Command4"
      Tab(2).Control(4)=   "Picture1(1)"
      Tab(2).ControlCount=   5
      TabCaption(3)   =   "Div"
      TabPicture(3)   =   "frmTagEdit.frx":019E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Picture1(2)"
      Tab(3).Control(1)=   "Command18(7)"
      Tab(3).Control(2)=   "Frame1(2)"
      Tab(3).Control(3)=   "Command6"
      Tab(3).ControlCount=   4
      TabCaption(4)   =   "Font"
      TabPicture(4)   =   "frmTagEdit.frx":01BA
      ...
      TabCaption(5)   =   "HR"
      TabPicture(5)   =   "frmTagEdit.frx":01D6
      ...
      TabCaption(6)   =   "Image"
      TabPicture(6)   =   "frmTagEdit.frx":01F2
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "Command18(10)"
      Tab(6).Control(1)=   "Frame1(5)"
      Tab(6).Control(2)=   "Command12"
      Tab(6).Control(3)=   "Picture1(5)"
      Tab(6).ControlCount=   4
      TabCaption(7)   =   "Radio"
      TabPicture(7)   =   "frmTagEdit.frx":020E
      Tab(7).ControlEnabled=   0   'False
      Tab(7).Control(0)=   "Picture1(13)"
      Tab(7).Control(1)=   "Command18(11)"
      Tab(7).Control(2)=   "Frame1(6)"
      Tab(7).Control(3)=   "Command15"
      Tab(7).Control(4)=   "Picture1(6)"
      Tab(7).ControlCount=   5
      TabCaption(8)   =   "Select"
      TabPicture(8)   =   "frmTagEdit.frx":022A
      Tab(8).ControlEnabled=   0   'False
      Tab(8).Control(0)=   "Picture1(14)"
      Tab(8).Control(1)=   "Command18(12)"
      Tab(8).Control(2)=   "Frame1(7)"
      Tab(8).Control(3)=   "Command17"
      Tab(8).Control(4)=   "Picture1(7)"
      Tab(8).ControlCount=   5
      TabCaption(9)   =   "Submit"
      TabPicture(9)   =   "frmTagEdit.frx":0246
      Tab(9).ControlEnabled=   0   'False
      Tab(9).Control(0)=   "Picture1(15)"
      Tab(9).Control(1)=   "Frame1(8)"
      Tab(9).Control(2)=   "Command19"
      Tab(9).Control(3)=   "Command18(0)"
      Tab(9).Control(4)=   "Picture1(8)"
      Tab(9).ControlCount=   5
      TabCaption(10)  =   "Text Area"
      TabPicture(10)  =   "frmTagEdit.frx":0262
      Tab(10).ControlEnabled=   0   'False
      Tab(10).Control(0)=   "Picture1(16)"
      Tab(10).Control(1)=   "Command18(1)"
      Tab(10).Control(2)=   "Frame1(9)"
      Tab(10).Control(3)=   "Command21"
      Tab(10).Control(4)=   "Picture1(9)"
      Tab(10).ControlCount=   5
      TabCaption(11)  =   "Hidden Text Input"
      TabPicture(11)  =   "frmTagEdit.frx":027E
      Tab(11).ControlEnabled=   0   'False
      Tab(11).Control(0)=   "Picture1(17)"
      Tab(11).Control(1)=   "Command18(2)"
      Tab(11).Control(2)=   "Frame1(10)"
      Tab(11).Control(3)=   "Command23"
      Tab(11).Control(4)=   "Picture1(10)"
      Tab(11).ControlCount=   5
      TabCaption(12)  =   "Visible Text Input"
      TabPicture(12)  =   "frmTagEdit.frx":029A
      Tab(12).ControlEnabled=   0   'False
      Tab(12).Control(0)=   "Command18(3)"
      Tab(12).Control(1)=   "Frame1(11)"
      Tab(12).Control(2)=   "Command25"
      Tab(12).Control(3)=   "Picture1(11)"
      Tab(12).ControlCount=   4
      TabCaption(13)  =   "Table"
      TabPicture(13)  =   "frmTagEdit.frx":02B6
      Tab(13).ControlEnabled=   0   'False
      Tab(13).Control(0)=   "Picture1(18)"
      Tab(13).Control(1)=   "Command1"
      Tab(13).Control(2)=   "Frame1(12)"
      Tab(13).Control(3)=   "Command18(13)"
      Tab(13).ControlCount=   4
      TabCaption(14)  =   "Td"
      TabPicture(14)  =   "frmTagEdit.frx":02D2
      Tab(14).ControlEnabled=   0   'False
      Tab(14).Control(0)=   "Command18(14)"
      Tab(14).Control(1)=   "frm1"
      Tab(14).Control(2)=   "Command3"
      Tab(14).ControlCount=   3
      TabCaption(15)  =   "Tr"
      TabPicture(15)  =   "frmTagEdit.frx":02EE
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox CoFonts 
            Height          =   315
            ItemData        =   "frmTagEdit.frx":809A
            Left            =   1680
            List            =   "frmTagEdit.frx":8212
            Style           =   2  'Dropdown List
            TabIndex        =   62
            Top             =   360
            Width           =   1830
...
Dialog.DialogTitle = "Browse for Picture..."
...
frmmain.rtbnet.SelText = frmmain.rtbnet.SelText + "<a href=" & Chr(34) & address2.Text & Chr(34) & ">" + "<img alt=" & Chr(34) & alt.Text & Chr(34) & ", src=" & Chr(34) & pic.Text & Chr(34) & " Border=0>" + "</a>"
Link2.address2.Text = ""
Link2.pic.Text = ""
Link2.alt.Text = ""
Exit Sub
...
On Error Resume Next
 frmmain.rtbnet.SelLength = frmmain.rtbnet.SelLength + 1
 TagLength = Len(frmmain.rtbnet.SelText)
 frmmain.rtbnet.SelStart = frmmain.rtbnet.SelStart - 1
 frmmain.rtbnet.SelLength = TagLength + 1
 Dim I As Integer
...
Continue:
         ...
         Case 6
          ...
          If AlignValueInTag = "CENTER" Then CoAlignImg.ListIndex = 3
         ...
         Case 14
          ...
          If ValignValueInTag = "CENTER" Then CoValignTD.ListIndex = 2
         ...
         Case 15
          ...
          If ValignValueInTag = "CENTER" Then CoValignTR.ListIndex = 1
...
On Error GoTo colorerror
frmmain.rtbnet.SelText = frmmain.rtbnet.SelText + "<a href=" & Chr(34) & address.Text & Chr(34) & ">" + link.Text + "</a>"
Link1.address.Text = ""
Link1.link.Text = ""
Exit Sub
colorerror:
